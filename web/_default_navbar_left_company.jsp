...
<div class="col-md-3">
        ...
        <a href="<s:url value="companyusuarios.action" />"><div <s:if test="%{#option=='usuario'}">style="background-color: #d58512"</s:if> class="well"><strong>CLIENTES</strong> </div></a>
        ...
        <a href="<s:url value="companyrutina.action"/>"><div <s:if test="%{#option=='rutina'}">style="background-color: #d58512"</s:if> class="well"><strong>RUTINAS</strong> </div></a>
</div>
