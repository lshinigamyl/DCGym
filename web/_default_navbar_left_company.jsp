...
<div class="col-md-3">
        ...
        <a href="<s:url value="companyentrenadores.action"/>"><div <s:if test="%{#option=='entrenador'}">style="background-color: #d58512"</s:if> class="well"><strong>ENTRENADORES</strong> </div></a>
    </div>
